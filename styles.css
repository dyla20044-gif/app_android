...
/* REQUERIMIENTO: Logo Animado (Sustituyendo el spinner genérico) */
#loader .loader-spinner {
    width: 80px; /* Tamaño del círculo externo */
    height: 80px;
    border-radius: 50%;
    /* Estilo del círculo base, usando el color de fondo para simular el aro */
...
#loader .loader-spinner i {
    font-size: 2.2em;
    color: var(--red-highlight);
    text-shadow: 0 0 5px var(--red-highlight); /* Efecto de brillo */
}
/* Eliminamos el @keyframes spin antiguo y usamos uno de pulso */
...
/* REQUERIMIENTO: Estilo del Icono de Cámara Estático */
.logo-text #logo-icon-cam {
    font-size: 1.2em; /* Un poco más pequeño que el texto */
    color: var(--red-highlight);
    padding: 5px;
    border: 2px solid var(--red-highlight); /* Simula el círculo exterior */
    border-radius: 50%;
}
